...
#    whole_file_size = whole_file_size + len(str(crypt_header_size)+'\0')
    ...
    with open(storage_file_name,'wb') as storage_file:
        ...
        for current_file_header in file_list:
            ...
            #print('abc' + '\\' + os.path.basename(current_file_header[0]))
            try:
                print(os.path.dirname(current_file_header[0]))
                print('abc' + '\\' + os.path.dirname(current_file_header[0]))
                os.mkdir('abc' + '\\' + os.path.dirname(current_file_header[0]))
                ...
                pass
            #print('abc' + '\\' + os.path.basename(current_file_header[0]))
            with open('abc' + '\\' + os.path.basename(current_file_header[0]),'w+b') as f:
                #print(os.path.basename(current_file_header[0]))

                #print('abc' + '\\' + current_file_header[0])
...
#---------------------------
#listofFiles = list_folder_files('todo.bin','zarquon')
#print(listofFiles)
#---------------------------
